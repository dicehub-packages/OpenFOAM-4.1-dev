...
fluentMeshToFoam
================
Conversion utility based on fluentMeshToFoam utility in OpenFOAM (
...
class fluentMeshToFoam(
    ...
    @diceSlot("QString", name="addMSH")
    def import_msh(self, files):
    ...
    @diceTask('fluentMeshToFoam')
    def run_fluent_mesh_to_foam(self):
        """ Execute conversion from MSH to OpenFOAM """
    ...
    @diceTask('checkMesh', run_fluent_mesh_to_foam)
