...
class potentialFoamApp(
    ...
    def on_input(self, type_name, app, value):
        """
        Is being called when input changes, for example when a
        connection to this app is created or removed.
        """
    ...
    def __load_input(self):
        ...
        self.load_boundary(boundary_props)
